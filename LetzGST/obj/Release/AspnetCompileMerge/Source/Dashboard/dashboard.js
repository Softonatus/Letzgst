...
//$(document).ready(function () {
    ...
    function defaultSelection() {
        ...
        fillExpensedetails($('#dpSelectTypeExpense option:selected').val(), $('#drpMonthQurterExpense option:selected').val());
        fillInvoicedetails($('#dpSelectTypeInvoice option:selected').val(), $('#drpMonthQurterInvoice option:selected').val());
    };
    ...
    $('#drpMonthQurterInvoice').on('change', function () {
        fillExpensedetails($('#dpSelectTypeInvoice option:selected').val(), this.value);
    });
    ...
    function fillInvoicedetails(type, value) {
        $.ajax({
            ...
            success: function (data) {
                ...
                alert("qw"+data.invoiceUtgst);
                    $("#InUTGST").text(data.invoiceUtgst.val());
