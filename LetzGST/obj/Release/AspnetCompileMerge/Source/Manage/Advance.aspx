<%@ Page Title="" Language="C#" MasterPageFile="~/GSTSite.Master" AutoEventWireup="true" CodeBehind="Advance.aspx.cs" Inherits="LetzGST.Manage.Advance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <!-- main Content starts here-->
          <div class="box clearfix">
                    <div class="box-header with-border">
                        <h3 class="box-title">Invoice Management : Advance Payment</h3>
                    </div>
                    <div class="box-body">
                                ...
                                <div class="row">
                                   <div class="col-md-6 col-sm-12 col-xs-12"></div>
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <a class="btn btn-ltz m-t-30 pull-right" id="addadvance"><span class="icon ico-add ico-2x"></span> Add Advance Payment</a>
                                    </div>
                                </div>
                                <br />
                                <div class="table-container">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="advancetbl" class="table table-striped table-bordered dt-responsive dataTable no-footer dtr-inline ltz-table" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Sr.no</th>
                                                    <th>Customer Name</th>
                                ...
                                <form id="frmAdvance" runat="server">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="btns-container">
                                                <div class="pull-left">
                                                    ...
                                                    <a class="btn letz-btn btn-ltz" id="backtoadvance"><span class="icon ico-back ico-2x"></span> Back</a>
                                                </div>
                                                ...
                                                <div class="pull-right">
                                                    ...
                                                    <a class="btn letz-btn btn-ltz" id="btn_SaveAdvance"><span class="icon ico-save ico-2x"></span> Save</a>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group ">
                                                <label class="control-label">Advance To</label>&nbsp; <span id="err_advanceto"></span>
                                                <select id="advanceto" name="advanceto" data-placeholder="Select " class="form-control chosen-select-deselect calculate" required="required">
                                                    <option></option>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label">Advance Date</label>  &nbsp;<span id="err_podate"></span>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group ">
                                                <label class="control-label">Payment Method</label>  &nbsp;<span id="err_paymentmetod"></span>
                                                <select id="paymentmetod" data-placeholder="Payment Terms" name="paymentmetod" class="form-control chosen-select-deselect" required="required">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group ">
                                                ...
                                                <select id="shippingState" name="state" data-placeholder="Select State" class="form-control chosen-select-deselect calculate" required="required">
                                                    <option></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <select id="invrefno" name="invrefno" data-placeholder="Select " class="form-control chosen-select-deselect">
                                                    <option></option>
                                    ...
                                    <div class="p-t-20">
                                        <table id="advancedetailstbl" class="table table-bordered dt-responsive dataTable no-footer dtr-inline ltz-table" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
...
<!-----send quotation start -->
    <div class="modal fade " id="sendquote" tabindex="-1" role="dialog" style="display: none;">
        <div class="modal-dialog custom-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="AdvanceLbl">Send Advance</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                                    ...
                                    <div id="my-container" class="pdfobject-container" style="overflow-y:auto;">
                                        <section style="padding:6mm">   
                                            <table style="border: solid 1px #666; font-family: monospace; font-size: 13px; line-height:18px;" width="100%" cellpadding='0' cellspacing='0' border='0' id="mytbl">
                                                <tr>
                                                    <td colspan="3" style="text-align: center;border-bottom: solid 1px #666;background-color: #dadada;height: 30px;font-size: 16px;"><strong>Advance Invoice</strong></td>
                                                </tr>
                                                <tr>
   ...
   <script type="text/javascript" src="../js/jsrender.js"></script>
    ...
    <script id="tblAdvanceDetails" type="text/x-jsrender">
        <tr id="{{:AdvanceId}}">
            <td></td>
            <td>{{:CustomerName}}</td>
            <td>{{:AdvanceDate}}</td>
            ...
            <%--<td>{{:Status}}</td>--%>
            <td>
              <%--  <a class="actions-btn" id="viewuser_{{:AdvanceId}}" title="View"><span class="icon ico-view ico-2x"></span></a>--%>
                <a class="actions-btn edit" id="edituser_{{:AdvanceId}}" title="Edit"><span class="icon ico-edit ico-2x"></span></a>
                <a class="actions-btn delete" id="deleteuser_{{:AdvanceId}}" title="Delete"><span class="icon ico-delete ico-2x"></span></a>
