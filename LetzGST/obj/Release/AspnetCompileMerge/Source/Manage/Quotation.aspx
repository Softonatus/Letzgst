<%@ Page Title="" Language="C#" MasterPageFile="~/GSTSite.Master" AutoEventWireup="true" CodeBehind="Quotation.aspx.cs" Inherits="LetzGST.Manage.Quotation" %>
         ...
         <%--   <div id="page-content-wrapper">--%>
                ...
                <div class="box clearfix">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Billing Management :  Quotation</h3>
                    </div>
                    <div class="box-body">
                        <div id="horizontalTab">
                            <div id="quotationtable">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <a class="btn btn-ltz m-t-30 pull-right" id="addquotation"><span class="icon ico-add ico-2x"></span> Add Quotation</a>
                                    </div>
                                </div>
                                <br />
                                    <div class="table-container">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="exptable" class="table table-striped table-bordered dt-responsive dataTable no-footer dtr-inline ltz-table" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Sr.no</th>
                                                    <th>Customer Name</th>
                            ...
                            <div id="addquote" style="display: none;">
                                <form id="addEstimate" runat="server">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="btns-container">
                                                <div class="pull-left">

                                                    <a class="btn letz-btn btn-ltz" id="backtoquote"><span class="icon ico-back ico-2x"></span> Back</a>
                                                </div>

                                                <div class="pull-right">
                                                    <%--<a class="btn letz-btn btn-ltz"> Preview</a>
                                                    <a class="btn letz-btn btn-ltz"> Cancel</a>--%>
                                                    <span id="PrintPdf" style="display:none"  onClick="printdiv('my-container');">
                                                        <a class="btn letz-btn btn-ltz"><span class="icon ico-printer ico-2x"></span> Print</a>
                                                    </span>
                                                    
                                                    <a class="btn letz-btn btn-ltz" id="saveQuotation"><span class="icon ico-save ico-2x"></span> Save</a>
                                                    <a href="" id="btnSendQuote" class="btn btn-ltz btn-outline" data-toggle="modal" data-target="#sendquote" style="display:none"><span class="icon ico-send ico-2x"></span> Send</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 no-gutter">
                                            <div class="col-md-3 col-sm-12 col-xs-12 ">
                                                <div class="form-group ">
                                                    ...
                                                    <select id="invoicetype" data-placeholder="Select Invoice Type" class="form-control chosen-select-deselect calculate" required="required">
                                                        <option></option>
                                                        ...
                                                        <option value="DeemExport">Deem Export</option>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group ">
                                                <label class="control-label">Quotation To</label> &nbsp; <span id="err_purchaseorderto"></span>
                                                <select id="purchaseorderto" name="purchaseorderto" data-placeholder="Select " class="form-control chosen-select-deselect" required="required">
                                                    <option></option>
                                                    <option value="addnewpoto" class="addnewtxt">Add New Text</option>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label">Quotation Date</label> &nbsp;<span id="err_podate"></span>
                                        ...
                                        <table id="potable" class="table table-bordered dt-responsive nowrap dataTable no-footer dtr-inline ltz-table" width="100%" cellspacing="0">
                                            ...
                                            <tbody id="tblItemDetails">
                                                <tr class="data-wrapper">
                                                    ...
                                                    <td>
                                                         <input type="text" class="form-control product-qty calculate" id="cess_1"><br /><span class="icon ico-rupees ico-3x"></span><span class="cessAmt">0</span>
                                                    </td>
                                                    <td width="2%">
...
<!-----send quotation start -->
                                ...
                                <div class="col-md-12">
                                    <div id="my-container" class="pdfobject-container" style="overflow-y:auto;">
                                        <section style="padding:6mm">   
                                            <table style="border: solid 1px #666; font-family: monospace; font-size: 13px; " width="100%" cellpadding='0' cellspacing='0' border='0' id="mytbl">
                                                <tr>
                                                    <td colspan="3" style="text-align: center;border-bottom: solid 1px #666;background-color: #dadada;height: 30px;font-size: 16px;"><strong>Quotation Invoice</strong></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 4px; border-bottom: solid 1px #666;">
                                                        <p style="margin:4px 0; padding: 0; border-bottom: solid 1px #666;"><strong>Quotation No:</strong> <span id="P_billno"></span></p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td style="padding: 4px; height: 150px; vertical-align: top;">Authorised Signatory </td>
                                                </tr>
                                            </table>
                                         </section>
                                    </div>
    ...
    <script id="tblQuotationList" type="text/x-jsrender">
        <tr id="{{:EstimateId}}">
            ...
            <td>Pending</td>
            <td>
               <%-- <a class="actions-btn" id="viewuser_{{:EstimateId}}" title="View"><span class="icon ico-view ico-2x"></span></a>--%>
                <a class="actions-btn edit" id="edituser_{{:EstimateId}}" title="Edit"><span class="icon ico-edit ico-2x"></span></a>
                <a class="actions-btn invoice" id="converttobill_{{:EstimateId}}" title="Covert to invoice"><span class="icon icon ico-invoice ico-2x"></span></a>
                <a class="actions-btn delete" id="deleteuser_{{:EstimateId}}" title="Delete"><span class="icon ico-delete ico-2x"></span></a>
