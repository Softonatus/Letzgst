...
{
    /// <summary>
    /// Summary description for ExpenseDashboard
    /// </summary>
    public class ExpenseDashboard : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (context.Session["UserDetails"] != null)
                {
                    ...
                    string url = generateReq.generateUrl("GetDashBoardContentExpense");
